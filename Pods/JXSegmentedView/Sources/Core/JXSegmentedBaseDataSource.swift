...
open class JXSegmentedBaseDataSource: JXSegmentedViewDataSource {
    ...
    open func preferredSegmentedView(_: JXSegmentedView, widthForItemAt _: Int) -> CGFloat {
    ...
    open func itemDataSource(in _: JXSegmentedView) -> [JXSegmentedBaseItemModel] {
        return dataSource
    }
    ...
    open func registerCellClass(in _: JXSegmentedView) {}

    open func segmentedView(_: JXSegmentedView, cellForItemAt _: Int) -> JXSegmentedBaseCell {
    ...
    public final func refreshItemModel(_: JXSegmentedView, _ itemModel: JXSegmentedBaseItemModel, at index: Int, selectedIndex: Int) {
        preferredRefreshItemModel(itemModel, at: index, selectedIndex: selectedIndex)
    }

    private func itemWidthWithZoom(at index: Int, model: JXSegmentedBaseItemModel) -> CGFloat {
        var width = segmentedView(JXSegmentedView(), widthForItemAt: index)
        if isItemWidthZoomEnabled {
