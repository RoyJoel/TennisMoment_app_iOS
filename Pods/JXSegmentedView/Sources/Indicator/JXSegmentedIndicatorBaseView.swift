...
open class JXSegmentedIndicatorBaseView: UIView, JXSegmentedIndicatorProtocol {
    ...
    open func refreshIndicatorState(model _: JXSegmentedIndicatorSelectedParams) {}

    open func contentScrollViewDidScroll(model _: JXSegmentedIndicatorTransitionParams) {}

    open func selectItem(model _: JXSegmentedIndicatorSelectedParams) {}
}
